        ...
        <div className="grid 4xs:grid-cols-1 xl:grid-cols-3 lg:w-[98%]">
          <div className="flex flex-col justify-center items-center">
            ...
            >
              ...
              <p className="text-center py-5">
                {" "}
                Montajul rigipsului garantează finisaje de calitate și
                compartimentări precise.
              </p>
            </motion.div>
          </div>
          <div className="flex flex-col justify-center items-center">
            ...
            >
              ...
              <p className="text-center py-5">
                {" "}
                Oferim instalații electrice sigure și eficiente, montate la
                standarde înalte.
              </p>
            </motion.div>
          </div>
          <div className="flex flex-col justify-center items-center">
            ...
            >
              ...
              <p className="text-center py-5">
                {" "}
                Acoperișuri durabile, montate cu grijă pentru protecția
                locuinței tale.
              </p>
            </motion.div>
          </div>
